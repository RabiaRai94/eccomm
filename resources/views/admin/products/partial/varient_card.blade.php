<div class="card" style="width: 18rem; height: 400px; display: flex; flex-wrap: wrap; margin-bottom: 1rem; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between">
            ...
            <button class="btn btn-primary btn-sm" onclick="openEditVariantModal({{ json_encode($variant) }})">Edit</button>

            <button class="btn btn-danger btn-sm delete-variant-btn" data-id="{{ $variant->id }}">Delete</button>
        </div>
    </div>
</div>
