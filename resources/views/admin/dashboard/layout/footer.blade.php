<!-- Footer -->
<footer class="text-center text-lg-start bg-light text-muted py-5">
    <!-- Section: Social media -->
    <section class="d-flex justify-content-center align-items-center border-bottom pb-4">
        <!-- Left -->
        <div class="me-3">
    ...
    <section class="container text-center text-md-start mt-5">
        <div class="row justify-content-center">
            ...
            <!-- Useful Links Column -->
            <div class="col-md-3 col-lg-2 col-xl-2 mb-4 d-flex flex-column">
            ...
            <!-- Contact Column -->
            <div class="col-md-4 col-lg-3 col-xl-3 mb-4 d-flex flex-column">
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.05);">
        © 2021 Copyright:
        <a class="text-reset fw-bold" href="https://abc.com/">ecomm.com</a>
    </div>
</footer>
<!-- Footer -->
